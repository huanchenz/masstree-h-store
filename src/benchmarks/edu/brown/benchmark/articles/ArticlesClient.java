...
public class ArticlesClient extends BenchmarkComponent {
    ...
    //private Zipf readRecord_zipf;
    //private Zipf userRecord_zipf;
    //private final Random readRecord;
    //private final Random userRecord;
    private final PowerLaw readRecord_powerlaw;
    private final PowerLaw userRecord_powerlaw;
	...
	//this.readRecord_zipf = new Zipf(this.rand_gen, 0, articlesSize, 1.0001);
	//this.userRecord_zipf = new Zipf(this.rand_gen, 0, usersSize, 1.0001);
	//this.readRecord = new Random();
	//this.userRecord = new Random();
	this.readRecord_powerlaw = new PowerLaw(this.rand_gen, 0, articlesSize, -0.3);
	this.userRecord_powerlaw = new PowerLaw(this.rand_gen, 0, usersSize, -0.3);
    ...
    protected boolean runOnce() throws IOException {
        ...
        switch (target) {
            ...
            case GET_COMMENTS: {
                ...
                //params = new Object[]{ ((Random) this.readRecord_zipf).nextInt() };
		params = new Object[]{ ((Random) this.readRecord_powerlaw).nextInt() };
                break;
            }
            case ADD_COMMENT: {
                //int a_id = this.readRecord.nextInt();
		//int a_id_random = this.readRecord.nextInt(ArticlesConstants.ARTICLES_SIZE);
		//int a_id = this.readRecord_zipf.nextInt();
		int a_id = this.readRecord_powerlaw.nextInt();
                //int u_id = this.userRecord.nextInt();// uid
		//int u_id = this.userRecord.nextInt(ArticlesConstants.USERS_SIZE);// uid
		//int u_id = this.userRecord_zipf.nextInt();// uid
		int u_id = this.userRecord_powerlaw.nextInt();// uid
		...
		//int u_id = this.userRecord_zipf.nextInt();
		int u_id = this.userRecord_powerlaw.nextInt();
